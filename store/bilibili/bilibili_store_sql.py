...
async def query_content_by_content_id(content_id: str) -> Dict:
    ...
    """
    try:
        return await unified_query_content("bilibili", content_id)
    except Exception as e:
...
async def add_new_content(content_item: Dict, task_id: str = None) -> int:
    ...
    """
    try:
        return await unified_add_content("bilibili", content_item, task_id)
    except Exception as e:
        utils.logger.error(f"新增内容失败: {content_item.get('bvid', 'unknown')}, 错误: {e}")
        raise
...
async def update_content_by_content_id(content_id: str, content_item: Dict) -> int:
    ...
    """
    try:
        return await unified_update_content("bilibili", content_id, content_item)
    except Exception as e:
...
async def query_comment_by_comment_id(comment_id: str) -> Dict:
    ...
    """
    try:
        return await unified_query_comment("bilibili", comment_id)
    except Exception as e:
...
async def add_new_comment(comment_item: Dict) -> int:
    ...
    """
    try:
        return await unified_add_comment("bilibili", comment_item)
    except Exception as e:
...
async def update_comment_by_comment_id(comment_id: str, comment_item: Dict) -> int:
    ...
    """
    try:
        return await unified_update_comment("bilibili", comment_id, comment_item)
    except Exception as e:
...
async def add_new_creator(creator_item: Dict) -> int:
    ...
    try:
        ...
        return await unified_add_content("bilibili", creator_item)
    except Exception as e:
        utils.logger.error(f"新增创作者失败: {creator_item.get('mid', 'unknown')}, 错误: {e}")
        raise
...
async def query_creator_by_user_id(user_id: str) -> Dict:
    ...
    try:
        ...
        return await unified_query_content("bilibili", user_id)
    except Exception as e:
...
async def update_creator_by_user_id(user_id: str, creator_item: Dict) -> int:
    ...
    try:
        ...
        return await unified_update_content("bilibili", user_id, creator_item)
    except Exception as e:
...
async def query_contact_by_up_and_fan(up_id: str, fan_id: str) -> Dict:
    """查询UP主和粉丝的关系（已废弃）"""
    utils.logger.warning("query_contact_by_up_and_fan 已废弃，请使用统一存储系统")
    return dict()


async def add_new_contact(contact_item: Dict) -> int:
    """新增UP主和粉丝的关系（已废弃）"""
    utils.logger.warning("add_new_contact 已废弃，请使用统一存储系统")
    return 0


async def update_contact_by_id(id: str, contact_item: Dict) -> int:
    """更新UP主和粉丝的关系（已废弃）"""
    utils.logger.warning("update_contact_by_id 已废弃，请使用统一存储系统")
    return 0


async def query_dynamic_by_dynamic_id(dynamic_id: str) -> Dict:
    """查询动态（已废弃）"""
    utils.logger.warning("query_dynamic_by_dynamic_id 已废弃，请使用统一存储系统")
    return dict()


async def add_new_dynamic(dynamic_item: Dict) -> int:
    """新增动态（已废弃）"""
    utils.logger.warning("add_new_dynamic 已废弃，请使用统一存储系统")
    return 0


async def update_dynamic_by_dynamic_id(dynamic_id: str, dynamic_item: Dict) -> int:
    """更新动态（已废弃）"""
    utils.logger.warning("update_dynamic_by_dynamic_id 已废弃，请使用统一存储系统")
    return 0
