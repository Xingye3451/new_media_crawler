-- =============================================
-- MediaCrawler Database Full Migration
-- Version: v1.0.0
-- Description: Create all tables based on current database structure
-- Execution Order: 01
-- =============================================
...
-- =============================================
-- 1. Unified Content Table (Core Table)
-- =============================================
...
CREATE TABLE `proxy_pool` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `proxy_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `port` int(11) NOT NULL,
  `proxy_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'http',
  `country` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `speed` int(11) DEFAULT '0',
  `anonymity` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Proxy pool table';
