...
storage:
  ...
  # 数据库配置
  database_url: "mysql+pymysql://root:password@localhost:3306/mediacrawler"
```
...
```bash
# 备份当前配置
cp config/config_storage.yaml config/config_storage.yaml.backup
